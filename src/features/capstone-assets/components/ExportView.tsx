...
export const ExportView: React.FC<ExportViewProps> = ({ selectedProject, handleStartOver }) => {
        ...
        <div className="bg-white p-8 rounded-xl shadow-lg w-full max-w-2xl mx-auto border border-slate-100 animate-fadeIn text-center">
            {isPreparing ? (
                ...
                <>
                    ...
                    <p className="text-slate-600 max-w-2xl mx-auto mt-2">
                        Download the generated assets for "<span className="font-semibold text-slate-700">{selectedProject?.title}</span>" or start a new project.
                    </p>
